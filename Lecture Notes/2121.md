...
* serial i/o is perfered sometimes because of cost and size of the wires but also because paralell i/o is susceptible to relfections and induced noises for long distance communcation. 
...
load your data into the UDR I/O location which acts as the data trasmission buffer. This then is moved to the shift register when the time has come
